...
async function displayCarbonUsage(apiKey, region) {
    ...
    {await axios
        ...
        console.log(error);loading.style.display = 'none';
...
function handleSubmit(e) {e.preventDefault();setUpUser(apiKey.value, region.value);}
...
clearBtn.addEventListener('click', (e) => reset(e));init();